...
from runrlbased5 import RunRLBased5
...
class SignalMode(Enum):
    ...
    RLBased5 = (lambda: RunRLBased5(config=Config_SUMO(), name="Reinforement Learning based Control"), "Reinforement Learning based Control 5")
